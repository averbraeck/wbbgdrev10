 ...
 */
public class RoadNAnimation extends Renderable2D implements ClonableRenderable2DInterface, Serializable
{
    /** */
            ...
            throws NamingException, RemoteException
    {
        ...
        return new RoadNAnimation((RoadN) newSource, this.printName, newSimulator, this.width);
    }
