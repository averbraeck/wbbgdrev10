 ...
 */
public class WaterwayTextAnimation extends TextAnimation
{
    /** */
     ...
     */
    public WaterwayTextAnimation(final Locatable source, final String text, final float dx, final float dy,
            final TextAlignment textPlacement, final Color color, final float fontSize, final OTSSimulatorInterface simulator)
            throws RemoteException, NamingException
    {
        super(source, text.replaceAll("[$]", ""), dx, dy, textPlacement, color, fontSize, simulator);
    }
    ...
    public TextAnimation clone(final Locatable newSource, final OTSSimulatorInterface newSimulator)
            throws RemoteException, NamingException
    {
        return new WaterwayTextAnimation(newSource, getText(), getDx(), getDy(), getTextAlignment(), getColor(), getFontSize(),
                newSimulator);
    }
