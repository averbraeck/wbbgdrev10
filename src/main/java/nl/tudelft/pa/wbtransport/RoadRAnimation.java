 ...
 */
public class RoadRAnimation extends Renderable2D implements ClonableRenderable2DInterface, Serializable
{
    /** */
            ...
            throws NamingException, RemoteException
    {
        ...
        RoadRTextAnimation wta =
                new RoadRTextAnimation(roadR, printName, 0.0f, 20.0f, TextAlignment.CENTER, Color.BLACK, 10.0f, simulator);
        // wta.setRotate(false);
        wta.setScale(false);
    }
            ...
            throws NamingException, RemoteException
    {
        ...
        return new RoadRAnimation((RoadR) newSource, this.printName, newSimulator, this.width);
    }
