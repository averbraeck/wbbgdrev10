 ...
 */
public class RoadZ extends OTSLink
{
    /** */
     ...
     */
    public RoadZ(Network network, String id, Node startNode, Node endNode, LinkType linkType, OTSLine3D designLine,
     ...
     *             or the end node of the link are not registered in the network.
     */
    protected RoadZ(Network newNetwork, OTSSimulatorInterface newSimulator, boolean animation, OTSLink link)
